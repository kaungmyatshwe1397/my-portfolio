...
const dockVariants = cva(
  "supports-backdrop-blur:bg-white/[0.08] mx-auto mt-8 flex h-[58px] w-max items-center justify-center gap-2 rounded-2xl border border-white/[0.12] p-2 backdrop-blur-md"
)
